...
from image_classification_simulation.models.clustering_tools import get_clustering_alg
...
class ImageSimilaritySearch:
    ...
    def save_cluster_ids_to_file(self, path: str ="./dataset_cluster_ids.csv"):
    ...
    def load_cluster_ids_from_file(self, path: str ="./dataset_cluster_ids.csv"):
    ...
    def find_similar_images(
        ...
        if topk:
            query_indices = self.sort_query_result(image,query_image_paths,topk)
